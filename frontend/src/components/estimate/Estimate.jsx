    ...
    <div className="estimate">
      ...
      <form className="estimate_form">
        ...
        <div className="form-check form-check-inline">
          <input className="form-check-input" type="checkbox" value="" id="service_1" />
          <label className="form-check-label" for="service_1">
            Window Washing
          </label>
        </div>
        <div className="form-check form-check-inline">
          <input className="form-check-input" type="checkbox" value="" id="service_2" />
          <label className="form-check-label" for="service_2">
            Siding Soft Wash
          </label>
        </div>
        <div className="form-check form-check-inline">
          <input className="form-check-input" type="checkbox" value="" id="service_3" />
          <label className="form-check-label" for="service_3">
            Gutter Cleaning
          </label>
        </div>
        <div className="form-check form-check-inline">
          <input className="form-check-input" type="checkbox" value="" id="service_4" />
          <label className="form-check-label" for="service_4">
            Fascia/Trim/Soffit Cleaning
          </label>
        </div>
        <div className="form-check form-check-inline">
          <input className="form-check-input" type="checkbox" value="" id="service_5" />
          <label className="form-check-label" for="service_5">
            Roof Cleaning
          </label>
        </div>
        <div className="form-check form-check-inline">
          <input className="form-check-input" type="checkbox" value="" id="service_6" />
          <label className="form-check-label" for="service_6">
